...
export const atiFlow = [
  {
    ...
    aliases: ['Ati Flow', 'Flow', 'the product'],
    status: 'current',
    author: 'Annuai',
    added: '2026-09-16',
    revisions: [
      {
        date: '2026-09-18',
        author: 'Annuai',
        note: 'Renamed from "Ati Flow" to "Overview" — inside the Ati Flow section, a page also titled "Ati Flow" read as "Ati Flow / Ati Flow" in the sidebar and breadcrumbs. "Ati Flow" kept as an alias so search still finds it.'
      }
    ],
    ...
    blocks: [
      ...
      cards([
        { title: 'Fleet Monitor', text: 'Live robots, tasks and traffic, by zone.', tag: 'Operations', to: '/ati-flow/fleet-monitor' },
        { title: 'Robots', text: 'Add, edit, assign to zone, mark for maintenance.', tag: 'Setup', to: '/ati-flow/robots' },
        { title: 'Maps', text: 'SLAM mapping, positions, zones, traffic and gate rules.', tag: 'Configuration', to: '/ati-flow/maps' },
        { title: 'Workflows', text: 'Mission and action design, patterns, priority rules, and the Workflow Builder.', tag: 'Configuration', to: '/ati-flow/workflows' },
        { title: 'Integrations', text: 'ERP connections, master data mapping, sync logs.', tag: 'Configuration', to: '/ati-flow/integrations' },
        { title: 'Setup & Config', text: 'Site, network, docks, users and roles.', tag: 'Configuration', to: '/ati-flow/setup-and-config' },
        { title: 'Debug', text: 'Low-level diagnostics. Configurator only.', tag: 'Diagnostics', to: '/ati-flow/debug' }
      ]),
      h('Where to go next'),
      p(
    ...
    classDef default fill:#ffffff,stroke:#d8dee5,color:#33403c;`,
      ...
      accordions([
        ...
        },
        {
          ...
          body: [
            p(
              'This branch does not appear in the team’s two architecture diagrams at all. It is reconstructed from the existing [[users|Users and permissions]] page, translated into this architecture’s app names, because the team asked for it to be represented here while it is confirmed.'
            ),
            defs([
              {
...

  {
    ...
    simple:
      'Four kinds of person use the system: someone on the floor, someone looking after a group of zones, someone accountable for the whole site, and the person who sets everything up. What each of them can and can’t do is deliberate, not accidental.',
    aliases: ['users', 'personas', 'who uses it', 'roles', 'permissions', 'access', 'operator', 'supervisor', 'configurator'],
    ...
    blocks: [
      ...
      callout(
        'A third name: System Integrator',
        [
      ...
      h('Permission matrix'),
      p('The most detailed statement of who can do what that exists — what each role can do on each page, at a glance:'),
      table(
    ...
    related: ['v-operator', 'v-fleet-supervisor', 'v-head-of-operations', 'v-solutions-architect', 'v-system-integrator', 'v-deployment-manager', 'configuration-layers', 'open-questions', 'architecture', 'zone', 'ui-debug', 'd-role-based-visibility', 'v-escalation']
  }
];
