...
export const decisions = [
...

  {
    ...
    blocks: [
      ...
      p('See [[processing-zone|Processing Area]] for what the entity actually does, and [[open-questions]] for the naming confusion this closes.')
    ],
