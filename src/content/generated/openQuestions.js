...
// Edit the source files in content-md/openQuestions/ instead, then run:
...
export const openQuestions = [
  {
    ...
    "blocks": [
      ...
      {
        "t": "h",
        "text": "Questions the team has raised"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "Questions raised in the 18 September 2026 system-understanding meeting"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "Questions raised in the Industrial Design 1:1"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "Questions raised by the current, on-the-ground deployment sequence"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "Questions raised by an internal design/architecture review"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "Questions the source material raises"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "Contradictions found in this folder"
      },
      {
        "t": "table",
        "head": [
      ...
      {
        "t": "h",
        "text": "Subjects with no source at all"
      },
      {
        "t": "list",
        "items": [
      ...
      {
        "t": "h",
        "text": "How to close one"
      },
      {
        "t": "p",
        "text": "Confirm the answer with the people who own it, then edit the relevant content file in `src/content/`, change the entry’s `status` from `needs-confirmation` to `current`, and remove the gap callout. The entry’s `sources` field should name where the answer came from."
      }
    ]
  }
];
