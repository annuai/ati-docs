...
// Edit the source files in content-md/vocabulary/ instead, then run:
...
export const vocabulary = [
  {
    ...
    "technical": "A Workflow Builder node group for physical-device interactions: Bluetooth connection, output control, input/output reset and waiting for an input signal.",
    "usedIn": [
      "[[ui-workflow-builder|Workflow Builder]]"
    ],
    "related": [
      "ui-workflow-builder",
      "v-rfid"
  ...
  },
  {
    ...
    "technical": "One automatic confirmation option in Workflow Builder. It can be selected on a Confirm node instead of manual confirmation through a Dispatch Button.",
    "usedIn": [
      "[[ui-workflow-builder|Workflow Builder]] — Confirm node"
    ],
    "related": [
      "ui-workflow-builder",
      "v-aiot"
  ...
  },
  {
    ...
    "technical": "A mobile robot capable of navigating and performing transport work without continuous manual driving.",
    "usedIn": [
      "Deployment conversations",
      "Engineering documentation",
      "The prototype page name \"AMR Trips\""
    ],
  ...
  },
  {
    ...
    "technical": "Ati is an OEM: the robots and the orchestration software that runs them are both built in-house. The fleet is not third-party software wrapped around third-party machines.",
    "usedIn": [
      "Describing what kind of company Ati is"
    ],
    "related": [
      "ati-robotics",
      "robot",
  ...
  },
  {
    ...
    "technical": "An automated vehicle used for material transport that traditionally follows defined routes or guidance infrastructure. AGVs differ conceptually from AMRs, which are designed for more autonomous navigation.",
    "usedIn": [
      "Factory automation",
      "Material handling"
    ],
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "t": "p",
        "text": "An intersection is where a fleet is most likely to jam. Without an ordering rule, two robots arriving from different directions can each wait for the other — see [[v-deadlock|deadlock]]. First-in-first-out gives a plain answer to who goes, and it is an answer a person can predict and explain."
      },
      {
        "t": "callout",
  ...
  },
  {
    ...
    "technical": "The ability of independently developed systems, devices, or robots to exchange information and operate together through compatible interfaces and shared conventions.",
    "usedIn": [
      "VDA 5050",
      "MassRobotics",
      "Multi-vendor fleets"
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "t": "h",
        "text": "How a robot is actually connected, in practice"
      },
      {
        "t": "p",
      ...
      {
        "t": "h",
        "text": "Map versions and fleet assignment"
      },
      {
        "t": "p",
      ...
      {
        "t": "callout",
        "title": "An unshipped internal request",
        "body": [
      ...
      {
        "t": "h",
        "text": "Multiple fleets, one server"
      },
      {
        "t": "p",
        "text": "A single Fleet Manager server commonly hosts several independent fleets — for separate plants, or separate customers entirely. Which fleets a given user can see and switch between, in the fleet dropdown, is scoped by their login, not by which server they're connected to."
      },
      {
        "t": "callout",
        "title": "Not yet documented",
  ...
  },
  {
    ...
    "technical": "One of the external system types Ati Flow’s orchestration layer connects to through APIs, alongside [[v-erp|ERP]] providers. Which providers are connected depends on what the client already runs.",
    "usedIn": [
      "The orchestration layer, as a source of demand"
    ],
    "related": [
      "integrations",
      "v-erp",
  ...
  },
  {
    ...
    "usedIn": [
      "The overview diagram, as a source of demand signals alongside ERP"
    ],
  ...
  },
  {
    ...
    "usedIn": [
      "The prototype navigation item \"WIP Inventory\""
    ],
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "t": "h",
        "text": "The mechanism, concretely"
      },
      {
        "t": "p",
        "text": "Fleet Manager takes a [[workflow|workflow]]’s start station, end station and material, and dispatches an available, nearby robot to execute the resulting [[trip|trip]]. That is the bridge between the information/booking layer and the execution layer — see [[information-vs-execution-layer]]."
      },
      {
        "t": "h",
        "text": "How it relates to Ati Flow"
      },
      {
        "t": "p",
        "text": "Fleet Manager is one of the three parts [[ati-flow|Ati Flow]] brings together, alongside [[v-deployment-manager|Deployment Manager]] and an orchestration layer. Today they are separate tools; Ati Flow is the product that combines them."
      },
      {
        "t": "callout",
        "title": "Not yet documented",
  ...
  },
  {
    ...
    "term": "Route Ops",
    "kind": "term",
    "simple": "Changing how robots are allowed to move around the map — for example taking a station out of service.",
    "technical": "Route operations are adjustments to the route network, such as excluding a station from the map. They are available in [[v-fleet-manager|Fleet Manager]] only, not in Ati Flow.",
    "aliases": [
      "route operations",
      "route ops"
    ],
  ...
  },
  {
    ...
    "technical": "An MHE code identifies a container for pickup/drop-off matching, the same operational role as a [[material-flow|Container ID]]. It does not map a container to a material type, and there is no empty-container or inventory tracking yet — acknowledged as a deliberate scope gap, to be extended as the system scales.",
    "usedIn": [
      "Container/pickup-drop matching"
    ],
  ...
  },
  {
    ...
    "kind": "term",
    "simple": "A configured part of a plant where the material, containers, workflows, devices and inventory for that operation are set up together.",
    "technical": "In AtiFLOW v2.0, a Processing Area is a plant-level configuration boundary. It contains machine details, linked stations, material and container configuration, workflows, device configuration and Processing Area inventory. Its system function is to segregate a relevant subset of Plant Master Data into a local material list for that operation.",
    "usedIn": [
      "AtiFLOW v2.0 — Central Configurations and Processing Areas Detailing",
      "The prototype sidebar selector (legacy label \"Processing Zone\")"
    ],
  ...
  },
  {
    ...
    "technical": "One of two machine-role tags used to classify a [[v-machine|Machine]] by its function in material movement, alongside [[v-consumption-unit|Consumption Unit]]. Whether this needs to remain an explicit, user-facing configuration or could instead be derived from the workflow itself is unresolved.",
    "usedIn": [
  ...
  },
  {
    ...
    "technical": "One of two machine-role tags used to classify a [[v-machine|Machine]] by its function in material movement, alongside [[v-production-unit|Production Unit]]. Whether this needs to remain an explicit, user-facing configuration or could instead be derived from the workflow itself is unresolved.",
    "usedIn": [
      "Machine classification"
    ],
  ...
  },
  {
    ...
    "technical": "Once a local material list exists for a [[v-processing-area|Processing Area]], materials or material groups are mapped to [[v-station|Stations]] to define availability and role — pickup/start point or drop/end point. These mappings are then used when creating [[workflow|workflows]]. Whether the same material or material group can be mapped to multiple stations, and how the system should choose between them during workflow creation, has not been confirmed.",
    "usedIn": [
      "Ati Flow Configurator — Zonal Configuration, Station Mapping"
    ],
  ...
  },
  {
    ...
    "technical": "AtiFLOW v2.0 separates execution sources from workflow logic. A Requester Device, MES event, Dispatcher Device or Supervisor Device can be configured as an execution source, with its own visibility and workflow bindings.",
    "usedIn": [
      "AtiFLOW v2.0 — Execution Source Configuration"
    ],
    "related": [
      "workflow",
      "v-requester-mode",
      "v-assignment-strategy",
      "v-pickup-confirmation-mode"
    ],
    "status": "current",
    "author": "Annuai",
    "added": "2026-09-17",
  ...
  },
  {
    ...
    "technical": "The v3 PRD says an administrator selects the mode when creating a requester user. Legacy allows a requester to choose pickup station, material and drop station. Structured follows Machine → Station → Workflow → [[v-bom|BOM]], using configured station mapping. Both modes can run in the same deployment.",
    "usedIn": [
      "AtiFLOW v3.0 — Requester Operating Mode"
    ],
    "related": [
      "v-execution-source",
      "v-station",
  ...
  },
  {
    ...
    "technical": "AtiFLOW v2.0 defines two choices: Request-based assignment, where the pickup, drop-off and material are already defined; and On-route Assignment, where they are determined from the execution trigger. The strategy is separate from the workflow itself.",
    "usedIn": [
      "AtiFLOW v2.0 — Workflow Configuration"
    ],
    "related": [
      "trip",
      "workflow",
      "v-execution-source",
      "v-request-based-assignment",
      "v-on-route-assignment"
    ],
    "status": "current",
    "author": "Annuai",
    "added": "2026-09-17",
  ...
  },
  {
    ...
    "technical": "The pickup station, drop-off station and material are predefined in the request. AtiFLOW v2.0 describes the resulting behaviour as request created, then trip created immediately.",
    "usedIn": [
      "AtiFLOW v2.0 — Workflow Configuration and Requester Flow"
    ],
    "related": [
      "v-assignment-strategy",
      "trip",
  ...
  },
  {
    ...
    "technical": "AtiFLOW v2.0 describes Dispatch Button and QR code scan as execution triggers for this strategy. For QR-based flows, the robot arrives, scans the code, reads trolley details and matches an active request before it executes the trip.",
    "usedIn": [
      "AtiFLOW v2.0 — Workflow Configuration and Requester Flow"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "At a Point Station or Staging Area, the v2 PRD provides Auto Confirmation or Manual Confirmation. Dispatcher involvement depends only on this setting: manual confirmation requires a dispatcher; automatic confirmation does not.",
    "usedIn": [
      "AtiFLOW v2.0 — Pickup Configuration"
    ],
    "related": [
      "v-point-station",
      "v-staging-area",
  ...
  },
  {
    ...
    "technical": "In the v3 PRD, handling granularity does not apply to a Point Station because it has no cells to enumerate. In v2, Point Station is one of the locations that can use auto or manual pickup confirmation.",
    "usedIn": [
      "AtiFLOW v2.0 — Pickup Confirmation Mode",
      "AtiFLOW v3.0 — Workflow Handling Granularity"
    ],
    "related": [
      "v-station",
      "v-staging-area",
      "v-pickup-confirmation-mode",
      "v-handling-granularity"
    ],
    "status": "current",
    "author": "Annuai",
    "added": "2026-09-17",
  ...
  },
  {
    ...
    "technical": "The v3 PRD replaces a single FIFO/LIFO setting with Fill Sequence and Retrieval Order. Fill Sequence can follow rows, columns or any available cell, with separate line and cell order settings.",
    "usedIn": [
      "AtiFLOW v3.0 — Deployment Manager staging area configuration"
    ],
    "related": [
      "v-staging-area",
      "v-retrieval-order",
  ...
  },
  {
    ...
    "technical": "The v3 PRD defines Retrieval Order independently from Fill Sequence. It can follow arrival order (FIFO or LIFO), position by row or column, or any available cell.",
    "usedIn": [
      "AtiFLOW v3.0 — Deployment Manager staging area configuration"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "The v3 PRD defines this per pickup and drop leg: Single Cell creates one trip for the next eligible cell; Whole Area creates one trip per eligible cell in the selected staging area. It is meaningful only for a multi-cell staging area, not a Point Station.",
    "usedIn": [
      "AtiFLOW v3.0 — Workflow Handling Granularity"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "The function Ati Flow performs. It sits between a factory’s material movement requirements and the robot fleet that executes those movements.",
    "usedIn": [
      "The product definition",
      "The architecture orchestration layer"
    ],
    "related": [
      "orchestration",
      "ati-flow",
  ...
  },
  {
    ...
    "technical": "The mapping stage of deployment. The robot is manually driven or walked through the full operating area to build a point cloud map, with pose graph optimization applied where drift could accumulate.",
    "usedIn": [
      "Deployment stage 3",
      "The Maps surface"
    ],
  ...
  },
  {
    ...
    "blocks": [
      ...
      {
        "t": "h",
        "text": "Remapping after a site changes"
      },
      {
        "t": "p",
        "text": "If the physical environment changes after go-live — new equipment, a removed cabinet — only the affected area is remapped, as a separate support task using different tooling from the initial deployment. The whole site is not remapped from scratch."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "technical": "The spatial substrate used for localization and operational behaviour. Purely for localization, with no inherent concept of zones or business logic.",
    "usedIn": [
      "The Maps surface",
      "Deployment stage 3"
    ],
  ...
  },
  {
    ...
    "technical": "Operational information layered onto the raw map: stations, behavioural zones, traffic controls, forbidden areas and preferred areas.",
    "usedIn": [
      "Deployment stage 4",
      "The Maps surface"
    ],
  ...
  },
  {
    ...
    "technical": "The robot’s position and orientation in a coordinate frame. In a 2D factory environment this is commonly represented as x, y position plus heading.",
    "usedIn": [
      "Localization",
      "Navigation",
      "Mapping",
  ...
  },
  {
    ...
    "technical": "An estimate of robot motion derived from onboard sensors such as wheel encoders, inertial sensors, or other motion measurements. Odometry accumulates error over time and is therefore commonly combined with other localization sources.",
    "aliases": [
      "odom"
    ],
    "usedIn": [
  ...
  },
  {
    ...
    "technical": "Accumulated error between a robot’s estimated pose and its actual pose. Drift is particularly important during long trajectories and mapping, where small errors can compound.",
    "usedIn": [
      "Mapping",
      "Localization",
      "Odometry"
  ...
  },
  {
    ...
    "technical": "A spatial sequence connecting a start position to a destination. A path describes where the robot should travel but does not necessarily specify the exact timing or velocity at every point.",
    "usedIn": [
      "Navigation",
      "Route planning",
      "VDA 5050"
  ...
  },
  {
    ...
    "technical": "The process of generating a collision-free path between a start and goal position while considering the map, obstacles, constraints, and other navigation requirements.",
    "usedIn": [
      "Navigation",
      "Autonomy",
      "Rerouting"
  ...
  },
  {
    ...
    "technical": "A time-parameterized description of motion that specifies position, velocity, acceleration, or other motion characteristics as a function of time. A trajectory is more specific than a path.",
    "usedIn": [
      "Motion planning",
      "Navigation",
      "Robot control"
  ...
  },
  {
    ...
    "technical": "A defined spatial point used to shape or specify a route. Waypoints can represent intermediate destinations, navigation constraints, or points that a robot is expected to pass through.",
    "usedIn": [
      "Navigation",
      "Path planning",
      "Route configuration"
    ...
    "revisions": [
      {
        "date": "2026-09-22",
        "author": "Annuai",
        "note": "Linked to the new [[v-waypoint-version]] entry — a different, unrelated sense of \"waypoint\" meaning the underlying map format (V2/V5), not a single point on a route."
      }
    ],
    "sources": [
      "Ati team — noted September 2026"
  ...
  },
  {
    ...
    "technical": "The broader autonomy function that combines localization, planning, obstacle handling, and motion execution to move a robot toward a goal.",
    "usedIn": [
      "Robot autonomy",
      "Fleet operations",
      "Maps"
  ...
  },
  {
    ...
    "blocks": [
      {
        "t": "h",
        "text": "P2P Routing (V2) vs Dynamic Routing (V5)"
      },
      {
        "t": "p",
        "text": "The practical difference between the two formats is how much of the route the deployment team has to draw by hand, versus how much the routing engine works out on its own."
      },
      {
        "t": "figure",
      ...
      {
        "t": "callout",
        "title": "Possibly confusable with Deployment Manager's own version number",
        "body": [
  ...
  },
  {
    ...
    "blocks": [
      {
        "t": "h",
        "text": "Where it's actually allowed"
      },
      {
        "t": "p",
  ...
  },
  {
    ...
    "technical": "A physical object or environmental feature whose position is assumed to remain fixed or change very slowly relative to the robot’s navigation cycle.",
    "usedIn": [
      "Navigation",
      "Mapping",
      "Obstacle avoidance"
  ...
  },
  {
    ...
    "technical": "A moving or potentially moving object, such as a person, forklift, pallet, or another robot, that must be considered during real-time navigation.",
    "usedIn": [
      "Navigation",
      "Obstacle avoidance",
      "Robot autonomy"
  ...
  },
  {
    ...
    "technical": "Generating a new path or trajectory after conditions change, such as an obstacle appearing, a route becoming unavailable, or a navigation constraint changing.",
    "usedIn": [
      "Navigation",
      "Obstacle avoidance",
      "Traffic and route changes"
    ],
    "related": [
      "v-path-planning",
      "v-rerouting",
  ...
  },
  {
    ...
    "technical": "Changing an existing route in response to a blocked path, traffic condition, unavailable resource, or other operational constraint.",
    "usedIn": [
      "Fleet operations",
      "Navigation",
      "Route configuration"
  ...
  },
  {
    ...
    "technical": "The process of associating observed or estimated robot motion and surroundings with corresponding features in a known map to improve pose estimation.",
    "usedIn": [
      "Localization",
      "Navigation"
    ],
  ...
  },
  {
    ...
    "technical": "Applying location-based rules to a geographical region. Depending on the system, a geofence can restrict access, impose speed limits, or trigger specific behaviours.",
    "usedIn": [
      "Navigation",
      "Map configuration",
  ...
  },
  {
    ...
    "technical": "An autonomous response to a navigation or execution failure, such as attempting to clear an obstacle, retrying a motion, stopping safely, or requesting intervention.",
    "usedIn": [
      "Robot autonomy",
      "Exception handling",
      "Blocked robots"
  ...
  },
  {
    ...
    "technical": "The autonomy function that processes sensor information to identify environmental features, obstacles, objects, or other information needed for navigation and behaviour.",
    "usedIn": [
      "Robot autonomy",
      "Obstacle detection",
      "Navigation"
  ...
  },
  {
    ...
    "technical": "A set of spatial points, typically generated from depth or LiDAR sensing, representing surfaces and objects in the environment. Ati’s mapping process produces a point-cloud map before a 2D representation is used at runtime.",
    "usedIn": [
      "Map creation",
      "Localization",
  ...
  },
  {
    ...
    "technical": "The process of combining measurements from different sensors or estimation systems to produce a more robust estimate of the robot’s state or environment.",
    "usedIn": [
      "Localization",
      "Perception",
      "Autonomy"
  ...
  },
  {
    ...
    "technical": "A map annotation that is always active based on location: speed-limited zones, ramp zones, docking zones. Distinct from traffic control.",
    "usedIn": [
      "Deployment stage 4",
      "Map annotation"
    ],
  ...
  },
  {
    ...
    "technical": "A traffic-control annotation governing multi-robot access at single-lane or alternating-direction sections. Separate from behavioural zones.",
    "usedIn": [
      "Deployment stage 4",
      "Fleet traffic arbitration in stage 6"
    ],
    "related": [
      "traffic-control",
      "v-gate",
  ...
  },
  {
    ...
    "technical": "A traffic-control annotation governing multi-robot access. Gates are where contention and deadlock are tested during fleet management.",
    "usedIn": [
      "Deployment stages 4, 6 and 8"
    ],
    "related": [
      "traffic-control",
      "v-exclusion-zone",
  ...
  },
  {
    ...
    "technical": "Fleet-level coordination of robot movement through shared spaces, intersections, gates, exclusion zones, and other constrained resources.",
    "usedIn": [
      "Fleet management",
      "Deployment stage 6"
    ],
  ...
  },
  {
    ...
    "technical": "A fleet-management mechanism in which a robot obtains exclusive or controlled access to a shared resource such as a gate, intersection, aisle, or exclusion zone.",
    "usedIn": [
      "Traffic management",
  ...
  },
  {
    ...
    "technical": "A competition between multiple robots for access to a shared resource. Contentions may occur at gates, intersections, exclusion zones, charging points, or other constrained resources.",
    "usedIn": [
      "Traffic management",
      "Deadlock handling"
    ],
  ...
  },
  {
    ...
    "usedIn": [
      "Everywhere in the product interface",
      "The Robots surface"
    ],
    "related": [
      "robot",
  ...
  },
  {
    ...
    "usedIn": [
      "The information architecture, as a page name"
    ],
  ...
  },
  {
    ...
    "technical": "A robot state or operational condition used to remove a robot from normal dispatch while it is being serviced. The exact Ati implementation and permissions should be confirmed.",
    "usedIn": [
      "The glossary",
      "Fleet Supervisors can \"mark for maintenance\" within their zone"
    ],
    "related": [
      "robot-states",
      "v-dispatch",
  ...
  },
  {
    ...
    "technical": "A robot state shown in the prototype as a red status pill and a pulsing red halo on the map. Automated blocked-robot alerts are used after go-live to pinpoint which routes or zones need correction.",
    "usedIn": [
      "The prototype status pill and map legend",
      "Deployment stage 9"
    ],
    "related": [
      "robot-states",
      "wf-exceptions",
      "v-recovery-behaviour"
    ],
    "status": "current",
    "author": "Annuai",
    "added": "2026-09-16",
  ...
  },
  {
    ...
    "usedIn": [
      "The prototype: the \"AMR Trips\" page, \"Trip Details\", and identifiers shaped like `TRP-20487`",
      "Fleet task allocation",
      "The Fleet Monitor task queue"
    ],
  ...
  },
  {
    ...
    "blocks": [
      {
        "t": "h",
        "text": "Dispatch as a station setting"
      },
      {
        "t": "p",
        "text": "Every station on a map is configured, once, with one of three dispatch behaviours — set in [[v-deployment-manager|Deployment Manager]], not chosen per trip:"
      },
      {
        "t": "table",
        "head": [
          "Setting",
          "What happens at that station"
        ],
        "rows": [
          [
            "Not required",
            "The robot doesn't stop — it passes through without pausing."
          ],
          [
            "Optional",
            "The robot waits up to a configured timeout (e.g. five minutes) for someone to press the dispatch button; if nobody does, it carries on by itself."
          ],
          [
            "Required (default)",
            "The robot waits indefinitely until the dispatch button is pressed."
          ]
        ]
      },
      {
        "t": "callout",
        "title": "Fixed per station, not per trip",
        "body": [
  ...
  },
  {
    ...
    "technical": "An Operator can raise a manual priority request, with the trade-off shown before confirming. Priority misuse is named as something that surfaces during real operation rather than in testing.",
    "usedIn": [
      "The Operator role",
      "Deployment stages 6, 8 and 9"
    ],
    "related": [
      "v-priority",
      "users",
  ...
  },
  {
    ...
    "technical": "A system responsible for managing multiple robots, including task assignment, robot state, traffic coordination, and operational monitoring.",
    "aliases": [
      "FMS",
      "fleet management"
    ],
  ...
  },
  {
    ...
    "technical": "The process of assigning transport or other robot tasks to available robots based on factors such as location, capability, workload, priority, and operational constraints.",
    "usedIn": [
      "Fleet management",
  ...
  },
  {
    ...
    "technical": "An operational property indicating whether a robot can be considered for task assignment. Availability may differ from the robot’s physical or execution state.",
    "usedIn": [
      "Task allocation",
      "Fleet monitoring"
    ],
  ...
  },
  {
    ...
    "technical": "The set of capabilities or constraints associated with a robot that determine which tasks it can execute, such as payload handling, attachments, navigation capabilities, or access to particular areas.",
    "usedIn": [
      "Task allocation",
      "Fleet management"
    ],
  ...
  },
  {
    ...
    "technical": "A state indicating that a robot has accepted a task and is actively executing the associated movement or action sequence.",
    "usedIn": [
      "Robot status",
      "Fleet monitoring"
    ],
  ...
  },
  {
    ...
    "technical": "A temporary execution state in which the current task remains active while robot motion or execution is suspended.",
    "usedIn": [
      "Robot control",
      "Fleet monitoring"
    ],
  ...
  },
  {
    ...
    "technical": "An operational state in which the robot is positioned at a charging station or dock and is replenishing stored electrical energy.",
    "usedIn": [
      "Robot status",
      "Fleet operations"
    ],
  ...
  },
  {
    ...
    "technical": "Payload type and handling method — top-load, tugger/cart, lift, or conveyor interface — are established at site assessment. A payload profile is then configured per robot.",
    "usedIn": [
      "Deployment stages 1 and 2"
    ],
    "related": [
      "robot",
      "material-flow",
  ...
  },
  {
    ...
    "technical": "The work of defining the solution and routes for a specific project before detailed design begins. Site assessment is described as solutioning work.",
    "usedIn": [
      "Deployment stage 1",
      "Referred to again in stage 8 as \"solutioning teams\""
    ],
    "related": [
      "wf-deployment"
    ],
  ...
  },
  {
    ...
    "technical": "A phased rollout: one robot on one route first, then expanding robot count and route complexity in stages. A deployment engineer typically stays on site for the first two to three weeks after handover.",
    "usedIn": [
      "Deployment stage 9"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "Final handover only happens after floor-testing confirms expected behaviour. Support shifts to remote operations after the first two to three weeks on site.",
    "usedIn": [
      "Deployment stages 8 and 9"
    ],
    "related": [
      "v-go-live",
      "wf-deployment"
  ...
  },
  {
    ...
    "technical": "Normal cycle times, blocked-robot frequency and battery consumption are recorded early after go-live, so later drift can be told apart from normal variance.",
    "usedIn": [
      "Deployment stage 9"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "A safety-related stop function intended to bring hazardous motion to a safe condition when an emergency situation is detected.",
    "aliases": [
      "Emergency Stop",
      "E-Stop",
      "emergency stop"
  ...
  },
  {
    ...
    "technical": "A defined physical or mapped region associated with safety constraints, such as reduced speed, restricted operation, or protective stopping behaviour.",
    "usedIn": [
      "Robot safety",
      "Map configuration"
    ],
  ...
  },
  {
    ...
    "technical": "A safety-rated sensing device used to monitor defined protective fields around a robot and trigger safety behaviour when an intrusion is detected.",
    "usedIn": [
      "Robot safety",
      "Obstacle detection"
    ],
  ...
  },
  {
    ...
    "technical": "A controlled safety-related stopping function intended to prevent hazardous motion while preserving the conditions required for a safe state.",
    "usedIn": [
      "Robot safety",
      "Safety systems"
    ],
  ...
  },
  {
    ...
    "technical": "An HTTP-based callback mechanism in which one system sends an event notification to a configured endpoint when a specified event occurs.",
    "usedIn": [
      "System integrations",
  ...
  },
  {
    ...
    "technical": "A publish-subscribe messaging protocol commonly used for IoT and machine-to-machine communication where devices publish messages to topics and subscribers receive relevant messages.",
    "usedIn": [
      "IoT",
      "Robot telemetry",
      "Connected systems"
  ...
  },
  {
    ...
    "technical": "A discrete occurrence in a software or operational system that can trigger processing, notifications, state changes, or downstream actions.",
    "usedIn": [
      "Integrations",
      "Orchestration",
      "Event-driven workflows"
  ...
  },
  {
    ...
    "technical": "A structured unit of information exchanged between software components, devices, or services through a communication mechanism.",
    "usedIn": [
      "Robot communication",
      "Integrations",
      "VDA 5050"
  ...
  },
  {
    ...
    "technical": "A VDA 5050 message used by the central control system to provide the mobile robot with an order containing the information required to execute a planned movement.",
    "usedIn": [
      "VDA 5050",
  ...
  },
  {
    ...
    "technical": "A VDA 5050 message containing the robot’s current state and execution information for the central control system.",
    "usedIn": [
      "VDA 5050",
      "Robot monitoring"
    ],
  ...
  },
  {
    ...
    "technical": "A VDA 5050 mechanism for requesting an immediate action independently of the normal order execution flow.",
    "usedIn": [
      "VDA 5050",
      "Robot control"
    ],
  ...
  },
  {
    ...
    "technical": "A distinct inventory identifier used to represent a specific product, material, or variant within an inventory system.",
    "usedIn": [
      "Material movement",
      "Inventory",
      "WMS/ERP integrations"
    ],
    "note": "A second, conflicting usage exists: an Ati support engineer used \"SKU\" informally to mean a robot's product type (Tugger, Pallet Mover, Lifter), unrelated to a material SKU. Recorded here rather than merged, since nothing confirms it as the intended internal term — see [[v-waypoint-version]] for the robot-type distinction it was describing.",
    "related": [
      "v-sub-sku",
      "v-wms",
      "v-erp",
    ...
    "revisions": [
      {
        "date": "2026-09-22",
        "author": "Annuai",
        "note": "Flagged a second, informal use of \"SKU\" to mean robot type, heard in an internal walkthrough — kept separate from this material-SKU definition rather than merged."
      }
    ],
    "sources": [
      "Ati team — noted September 2026",
  ...
  },
  {
    ...
    "technical": "A lower-level material identifier used when a workflow needs to distinguish components, variants, or material units within a broader SKU hierarchy.",
    "usedIn": [
      "Material movement workflows",
      "Pick and drop operations"
    ],
    "related": [
      "v-sku",
      "v-material-flow"
  ...
  },
  {
    ...
    "technical": "The movement of raw materials, components, work-in-progress, and finished goods between locations or process steps within a manufacturing environment.",
    "usedIn": [
      "Material orchestration",
      "Factory operations"
    ],
  ...
  },
  {
    ...
    "technical": "The production-side location where components or materials are staged for operators or machines to consume during manufacturing.",
    "usedIn": [
      "Material movement",
  ...
  },
  {
    ...
    "technical": "An intermediate storage or staging location used to decouple two processes and absorb differences in their timing or throughput.",
    "usedIn": [
      "Material flow",
      "Manufacturing logistics"
    ],
  ...
  },
  {
    ...
    "technical": "A controlled inventory area positioned near consumption points and replenished according to demand, commonly associated with lean manufacturing and pull-based material flow.",
    "usedIn": [
      "Manufacturing logistics",
  ...
  },
  {
    ...
    "technical": "A pull-based production and replenishment method in which a signal triggers the movement or production of material when inventory is consumed.",
    "usedIn": [
      "Material replenishment",
      "Lean manufacturing"
    ],
  ...
  },
  {
    ...
    "technical": "The available production time divided by customer demand. It represents the required production rhythm rather than the actual time required to manufacture one item.",
    "usedIn": [
  ...
  },
  {
    ...
    "technical": "The elapsed time required to complete one unit or one repeatable process cycle. It is distinct from takt time, which represents the required production rate.",
    "usedIn": [
      "Manufacturing operations",
      "Material movement"
    ],
  ...
  },
  {
    ...
    "technical": "The rate at which units, materials, tasks, or other work items are completed or transported by a system.",
    "usedIn": [
      "Factory analytics",
      "Fleet performance",
      "Material flow"
  ...
  },
  {
    ...
    "technical": "A low-level configuration and diagnostics area — raw robot state, calibration, overrides, diagnostic logs — assigned exclusively to the Configurator role in the current IA.",
    "usedIn": [
      "The information architecture, as a page name"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "ROC is not a team and not related to [[v-feluda|Feluda]] — the two are separate, unconnected tools that were previously and incorrectly documented as linked. Why it was not adopted more widely, and whether it has been fully retired or is still running in a limited capacity, has not been confirmed.",
    "related": [],
    "status": "deprecated",
    "author": "Annuai",
    "added": "2026-09-18",
  ...
  },
  {
    ...
    "technical": "Feluda is currently in use by [[v-validation|Validation]] for tracking, analytics and metrics. It is unrelated to [[v-roc|ROC]] — a separate, deprecated in-house tool — despite both being named together in earlier drafts of this and the ROC entry.",
    "usedIn": [
      "Validation"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "Sees Fleet Monitor for their own zone — robot status and task queue. Can raise a manual priority request, with the trade-off shown before confirming. View-only on Robots in their zone. Maps, Workflows, Integrations, Setup and Debug are entirely hidden.",
    "usedIn": [
      "The role and permission model"
    ],
    "related": [
  ...
  },
  {
    ...
    "blocks": [
      {
        "t": "h",
        "text": "What the job is"
      },
      {
        "t": "p",
        "text": "Narrow and reactive. A Fleet Supervisor handles robots that have run into trouble, and nothing more. The scope is deliberate: they are not given the data they would need to manage anything beyond that, so the role cannot quietly widen into general operations."
      },
      {
        "t": "p",
        "text": "The closest comparison is a support engineer who works on the floor rather than remotely."
      },
      {
        "t": "h",
        "text": "Whether the role is needed"
      },
      {
        "t": "p",
        "text": "This is genuinely undecided. The argument against it is straightforward: **[[v-operator|Operators]] already manage the robots when there is an issue.** If that is the whole of the Fleet Supervisor job, and the person already standing on the floor is doing it, a separate persona may not be necessary."
      },
      {
        "t": "callout",
        "title": "Why it matters before it is decided",
        "body": [
  ...
  },
  {
    ...
    "technical": "Named in the IA as Supervisor (Head of Operations). Fleet Monitor across all zones, manages robots site-wide, views and approves Workflows and Maps, views Integrations status, and manages users and roles. Debug is hidden.",
    "usedIn": [
      "The role and permission model"
    ],
    "related": [
  ...
  },
  {
    ...
    "technical": "Resolved: System Integrator and [[v-solutions-architect|Solutions Architect (Configurator)]] name the same person and the same permission role in the four-user model, viewed from two different angles. Solutions Architect / Configurator describes what they do inside the product — full setup authority. System Integrator describes who they typically work for: a third-party company reselling or deploying the system alongside the client’s own ERP, rather than an Ati employee. It is an organisational descriptor, not a fifth persona.",
    "usedIn": [
      "Third-party resale and deployment",
      "The role and permission model"
    ],
  ...
  },
  {
    ...
    "technical": "A statement of intent for a product or a release: the problem, the users, the behaviour expected of the system and the boundaries of scope. It describes the product from the outside — what it must do — rather than the implementation.",
    "usedIn": [
  ...
  },
  {
    ...
    "kind": "acronym",
    "simple": "The document that says how the system has to behave, function by function, so that the product does what the PRD asked for.",
    "technical": "Where a [[v-prd|PRD]] states the intent, an FRD states the required behaviour: inputs, outputs, rules, states and conditions for each function, written so that an implementation can be checked against it. It is the layer between a product decision and a testable requirement.",
  ...
  },
  {
    ...
    "kind": "acronym",
    "simple": "A structured way of asking, before anything is built, how a design could fail — and deciding what to change about the worst answers.",
    "technical": "A design-stage analysis that enumerates the ways each function of a design can fail, the effect and cause of each failure, and the controls already in place. Severity, occurrence and detection are rated and combined into a risk priority, which drives the actions taken back into the design. It is a living document, revisited as the design changes.",
  ...
  },
  {
    ...
    "technical": "A trolley AMR rated for a 10,000 lb (4,600 kg) payload, using natural-feature navigation with an 8-hour battery, for indoor and outdoor trolley towing.",
    "usedIn": [
      "Heavy trolley towing between fixed points, indoors and outdoors"
    ],
    "related": [
      "v-sherpa",
      "robot",
  ...
  },
  {
    ...
    "technical": "An AMR rated for a 3,300 lb pallet payload at up to 1.5 m/s, using LiDAR- and camera-based natural navigation with dynamic obstacle avoidance, for receiving, staging and line-side delivery.",
    "usedIn": [
      "Pallet receiving, staging and line-side delivery"
    ],
    "related": [
      "v-sherpa",
      "robot",
  ...
  },
  {
    ...
    "technical": "An AMR rated for a 1,100 lb (500 kg) payload at up to 1.2 m/s, using 3D-LiDAR natural navigation, with modular top-module configurations for pallet and bin handling. One main battery plus two auxiliary batteries give roughly 110 Ah of total power, and a turntable lets it deliver material in a precise pose.",
    "note": "Built from the outset for partners to extend, rather than as an Ati-only product.",
    "usedIn": [
      "Pallet and bin handling",
      "Partner-built applications on a shared platform"
    ],
    "related": [
      "v-sherpa",
      "robot",
  ...
  },
  {
    ...
    "technical": "A wheeled mobile robot with two carbon-fibre, cable-driven arms and a tool-changer instead of fingers, so tools are swapped for the task rather than built into a fixed hand. At announcement it carries 12 kg total (6 kg per arm); the next iteration is targeted at 35 kg. It is offered as a research prototype for partner pre-booking rather than a shipping product.",
  ...
  },
  {
    ...
    "technical": "A suite of Ati-built accessories and integrations — lift integration, conveyor integration, intelligent traffic management and staging-area management — that let a robot fleet be orchestrated into a complete, largely zero-touch workflow rather than just point-to-point driving.",
    ...
    "usedIn": [
      "End-to-end automation workflows shown at Product Day 2025"
    ],
    "related": [
      "orchestration",
      "v-sherpa",
  ...
  },
  {
    ...
    "blocks": [
      {
        "t": "callout",
        "title": "The wording is not user-friendly",
        "body": [
