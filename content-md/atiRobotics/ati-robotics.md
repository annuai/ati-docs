...
Two halves of one system, both made in-house:
...
It also explains the shape of this documentation. Robot-level configuration, the [[map|map]] and the [[missions-and-actions|workflow]] logic are all Ati’s concern, which is why [[configuration-layers]] runs from drive parameters all the way up to business-system integration.

## A partner, not a box seller
...
## Scale, as stated on the company website

Company-reported figures, not independently verified in this documentation:
...
The Sherpa product family, as named on the company’s products page and shown at Product Day 2025:
...
For the software half in detail, read [[ati-flow|the Ati Flow overview]].
